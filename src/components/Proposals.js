...
router.post('/create', upload.single('image'), async (req, res) => {
  ...
  try {
    ...
    console.log(`Snapshot address counts: ${JSON.stringify(addressCounts)}`);
...
router.post('/vote', async (req, res) => {
  ...
  try {
    ...
    console.log(`NFT Count for Address: ${nftCount}`);
    if (!nftCount) {
      console.log(`Address ${normalizedWalletAddress} not found in snapshot.`);
